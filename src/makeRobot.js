...
/**
 * Mate Robot Factory impressed by your success, they are ready to accept you into the Tech team,
 * you will learn to program robots together with the team! Are you in business As a test task,
 ...
 *  - Default methods that move the work by 1 in the right direction. This value can be increased by passing the desired number to the method.
 *    Negative numbers should not affect the location of the robot. goLeft(3)
 *  - The coordinates of the robot must be stored in the object coords, the keys x and y inside the robot.
 *  - The robot must be able to request the evacuation of robot.evacuate(), which will call rescuers and transfer
