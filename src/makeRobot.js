...
function makeRobot(name, wheels, version, x = 0, y = 0) {
  // write code here
  const ordinaryStep = 1;
  const pointToEvacuation = {
    x: 1400,
    y: 500,
  };
  ...
  const robot = {
    ...
    evacuate() {
      this.coords.x = pointToEvacuation.x;
      this.coords.y = pointToEvacuation.y;
    },
  };
